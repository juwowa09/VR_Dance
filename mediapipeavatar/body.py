...
class CaptureThread(threading.Thread):
    ...
    # def run(self):
    #     self.cap = cv2.VideoCapture("test3.mov")  # 비디오 파일 입력
...
class BodyThread(threading.Thread):
    ...
    def run(self):
        ...
        with mp_pose.Pose(min_detection_confidence=0.50, 
                ...
                if global_vars.DEBUG:
                    ...
                    if results.pose_landmarks:
                        mp_drawing.draw_landmarks(image, results.pose_landmarks, mp_pose.POSE_CONNECTIONS, 
                                                mp_drawing.DrawingSpec(color=(255, 255, 0), thickness=5, circle_radius=4), # 점 속성
                                                mp_drawing.DrawingSpec(color=(255, 255, 255), thickness=5, circle_radius=2), # 선 속성
                                                )
