...
public class ServerUDP : MonoBehaviour 
{
    ...
    public void Init(string ip, int port, bool suppressWarnings = true, int maximumMessageBufferSize = 100)
    {
    ...
    //                             if (!suppressWarnings)
    //                                 print(
    //                                     "Too slow to keep up with packets being sent (dropping old data). Make sure you are getting messages with GetMessage().");
    //                         }
    //
